...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    private boolean mDragViewStopWhenRelease = true;
    private boolean mIsDragViewClickable;
    ...
    // 停止滑动时是否停留在当前位置
    public void setPanelStopWhenRelease(boolean stopWhenRelease) {
        mDragViewStopWhenRelease = stopWhenRelease;
    }

    // DragView是否能够响应电
    public void setDragViewClickable(boolean clickable) {
        mIsDragViewClickable = clickable;
    }
        ...
        if (mDragView != null) {
            ...
            mDragView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (!isEnabled() || !isTouchEnabled() || !isClickEnabled()) return;
    ...
    public void draw(Canvas c) {
        ...
        if (mShadowDrawable != null && mSlideableView != null) {
            ...
            if (mIsSlidingUp) {
                ...
                Log.d("scrollUD","ScrollUpTop："+top);
                Log.d("scrollUD","ScrollUpBottom："+bottom);
            } else {
                top = mSlideableView.getBottom();
                bottom = mSlideableView.getBottom() + mShadowHeight;

                Log.d("scrollUD","ScrollDownTop："+top);
                Log.d("scrollUD","ScrollDownBottom："+bottom);
            }
    ...
    public boolean isSlideUp(){
        return mCurrentDy * (mIsSlidingUp ? 1 : -1) < 0;
    }
}
